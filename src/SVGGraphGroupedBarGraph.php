...
class GroupedBarGraph extends BarGraph
{
    protected function Draw()
    {
      ...
      self::BarPosition($this->bar_width, $this->bar_width_min,
   ...
   */
  public static function BarPosition($bar_width, $bar_width_min, $unit_width,
   ...
   */
  public static function BarPositionFixed($bar_width, $unit_width, $group_size,
    $group_space)
  {
