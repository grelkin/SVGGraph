...
/**
 * BezierGraph - joined line, with axes and grid.
 */
class BezierGraph extends PointGraph
{
  ...
  public function DrawLine($dataset, $points, $y_bottom, $stroke_colour = false)
  {
    ...
    // We have to supply the Q command with number of points which should be divisible by 4
